...
//! Oh no!
//! The new zookeeper has lost track of how many animals are in the zoo because 
//! the last person to do the count thought it would be funny to do it in binary.
...
const countTheAnimals = (l) => Object.values(l).reduce((a,b)=>a+parseInt(b,2),0)
